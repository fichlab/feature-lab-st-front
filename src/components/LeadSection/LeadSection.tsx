  ...
  return (
    <section className={cl(s.lead, className)}>
      ...
      <p className={cl(s.description)}>
        ...
        <br />
        <br />
        2–3, может быть 4 абзаца по 150-200 знаков, чтобы это можно было легко и быстро воспринять и
        понять, о чем речь. Пытаться казаться более знающими, чем есть на самом деле, за счёт
        использования умных слов точно не стоит.
        <br />
        <br />
        Можно добавить ещё блоки-пунктики с какими‑нибудь цифрами «улучшатели показателей» и вот это
        вот всё, как на главной странице на экране мастерской.
      </p>
